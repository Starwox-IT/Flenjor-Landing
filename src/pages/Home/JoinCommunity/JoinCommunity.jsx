        ...
        <section className="py-24 md:py-20 font-['Inter'] relative overflow-hidden bg-gradient-to-r from-[#E15B2E] to-[#7B3219]">
            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 flex flex-col items-center text-center">
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-6 w-full max-w-sm sm:max-w-md mx-auto">
                    <button className="w-full sm:w-1/3 px-8 py-2.5 rounded-lg bg-white text-[#E15B2E] font-medium text-[15px] hover:bg-gray-100 transition-colors shadow-lg">
                        Shop Now
                    </button>
                    <button className="w-full sm:w-1/3 px-6 py-2.5 rounded-lg border border-white text-white font-medium text-[15px] hover:bg-white/10 transition-colors">
                        Contact Us
                    </button>
                </div>
